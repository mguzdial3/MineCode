...
print "Telling the environment to use fixed start state of 1,2."
RLGlue.RL_env_message("set-start-state 1 2");
RLGlue.RL_start();
print "Telling the environment to print the current state to the screen."
RLGlue.RL_env_message("print-state");
print "Evaluating the agent a few times from a fixed start state of 1,2:\n\t\tMean Return\tStandardDeviation\n-------------------------------------------"
single_evaluation();
